    ...
    $.getJSON("http://api.openweathermap.org/data/2.5/weather?id=2953395&appid=4547f2adec926a8062406d71a2aba04c",
		...
		if (dscptn == "800" || dscptn == "904" || dscptn == "951") {
			if (timeData < sunSet && timeData > sunRise) {
				...
				document.getElementById("wetterIcon").src="../img/wetter/sonne.png";
			}
			else {
				document.getElementById("desc").innerHTML = "klar";
				document.getElementById("wetterIcon").src="../img/wetter/mond.png";
			}
		}
		else if (dscptn == "801" || dscptn == "802") {
			if (timeData < sunSet && timeData > sunRise) {
				document.getElementById("desc").innerHTML = "leicht bewölkt";
				document.getElementById("wetterIcon").src="../img/wetter/leicht_bewoelkt.png";
			}
			else {
				document.getElementById("desc").innerHTML = "leicht bewölkt";
				document.getElementById("wetterIcon").src="../img/wetter/leicht_bewoelkt_nachts01.png";
			}
		}
		else if (dscptn == "803") {
			if (timeData < sunSet && timeData > sunRise) {
				document.getElementById("desc").innerHTML = "bewölkt";
				document.getElementById("wetterIcon").src="../img/wetter/stark_bewoelkt.png";
			}
			else {
				document.getElementById("desc").innerHTML = "bewölkt";
				document.getElementById("wetterIcon").src="../img/wetter/stark_bewoelkt_nachts01.png";
			}
		}
		else if (dscptn == "804") {
			document.getElementById("desc").innerHTML = "bedeckt";
			document.getElementById("wetterIcon").src="../img/wetter/wolkendecke.png";
		}
		else if (dscptn >= "300" && dscptn <= "321") {
			document.getElementById("desc").innerHTML = "Nieselregen";
			document.getElementById("wetterIcon").src="../img/wetter/leichter_regen.png";
		}
			...
			document.getElementById("wetterIcon").src="../img/wetter/starkregen.png";
		}
		else if (dscptn == "511") {
			document.getElementById("desc").innerHTML = "gefrierender Regen";
			document.getElementById("wetterIcon").src="../img/wetter/gefrierender_regen.png";
		}
		else if (dscptn >= "520" && dscptn <= "531") {
			document.getElementById("desc").innerHTML = "Regen";
			document.getElementById("wetterIcon").src="../img/wetter/regen.png";
		}
		else if (dscptn >= "600" && dscptn <= "622") {
			document.getElementById("desc").innerHTML = "Schneefall";
			document.getElementById("wetterIcon").src="../img/wetter/schneefall.png";
		}
		else if (dscptn >= "200" && dscptn <= "232") {
			document.getElementById("desc").innerHTML = "Gewitter";
			document.getElementById("wetterIcon").src="../img/wetter/gewitter.png";
		}
		else if (dscptn >= "701" && dscptn <= "761") {
			document.getElementById("desc").innerHTML = "neblig";
			document.getElementById("wetterIcon").src="../img/wetter/neblig.png";
		}
		else if (dscptn == "906") {
			document.getElementById("desc").innerHTML = "Hagel";
			document.getElementById("wetterIcon").src="../img/wetter/hagel.png";
		}
		else {
			document.getElementById("desc").innerHTML = "Weltuntergang";
			document.getElementById("wetterIcon").src="../img/wetter/sonnenuntergang02.png";
		}
...
<?php
   $con = mysqli_connect("localhost", "wetterman", "yvZn5i2#BL", "wetter");
