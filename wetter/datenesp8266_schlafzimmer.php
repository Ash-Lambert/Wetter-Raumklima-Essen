...
<head>
<meta charset="utf-8">
    <title>Wetter Schlafzimmer</title>
...
<li><a href="history_intern.php">Historie</a></li>
  ...
  <br>
  <p class='wettertabelleueberschrift'>Wetter Schlafzimmer</p><hr>
<br><br>
<?php
...
<?php
   $con = mysqli_connect("HOST", "NAME", "PASSWORT", "DATENBANK");
   $res = mysqli_query($con, "SELECT DATE_FORMAT(datum, '%d.%m.') AS datum, DATE_FORMAT(zeit, '%H:%i') AS zeit, temp, humi FROM schlafzimmer ORDER BY id DESC LIMIT 49;");
...
<div class="navbar">
  ...
  <a href="datenesp8266_schlafzimmer.php" class="active"><img class="tableWeatherIcons" src="../img/bottommenu/schlafzimmer01.png"></a>
