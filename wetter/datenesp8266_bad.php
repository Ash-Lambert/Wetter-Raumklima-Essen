...
<nav>
  ...
  <br>
  <p class='wettertabelleueberschrift'>Wetter Bad</p><hr>
<br><br>
<?php
...
<?php
   $con = mysqli_connect("HOST", "NAME", "PASSWORT", "DATENBANK");
   $res = mysqli_query($con, "SELECT DATE_FORMAT(datum, '%d.%m.') AS datum, DATE_FORMAT(zeit, '%H:%i') AS zeit, temp, humi FROM bad ORDER BY id DESC LIMIT 49;");
...
<div class="navbar">
  ...
  <a href="datenesp8266_bad.php" class="active"><img class="tableWeatherIcons" src="../img/bottommenu/bad01.png"></a>
